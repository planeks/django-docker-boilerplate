...
CELERYBEAT_SCHEDULE_FILENAME = config('CELERYBEAT_SCHEDULE_FILENAME', default=BASE_DIR / 'celerybeat-schedule.db')
...
if CONFIGURATION == 'dev':
    ...
    EMAIL_FILE_PATH = config('EMAIL_FILE_PATH', default=os.path.join(BASE_DIR, 'email'))
